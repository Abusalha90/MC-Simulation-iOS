...
struct GeometryView: View {
    ...
    @State var selectedRegion:Region = Region(id: 0, material: .Fuel, xLeft: 0.0, thickness: 0.0, data: [])
            ...
            ScrollView(.horizontal) {
                ...
                HStack(spacing: 0) {
                    ...
                    .onTapGesture {
                        ...
                        selectedRegion = Region(id: (object.regions.last?.id ?? 0) + 1, material: .Fuel, xLeft: object.rightBoundary, thickness: 10, data: [Xs.init()])
                        editMode = .add
                        presentView.toggle()
                    }
